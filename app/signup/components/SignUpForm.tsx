...
const SignUpForm = () => {
  ...
  return (
    <div className="w-full max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
      ...
      <p className="text-center text-gray-600 mb-8">Join Queen of Aroma</p>

      {displayError && displayError !== "Error fetching user" && (
        <div
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <input
              ...
              required
              minLength={6}
              className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-black pr-10 ${localError === "Passwords do not match" ? "border-red-400" : "border-gray-300"}`}
            />
            <button
              type="button"
